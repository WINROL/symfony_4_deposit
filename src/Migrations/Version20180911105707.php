...
final class Version20180911105707 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE deposit (id INT AUTO_INCREMENT NOT NULL, account_id BIGINT NOT NULL, percent NUMERIC(2, 1) NOT NULL, start_dt DATETIME NOT NULL, close_dt DATETIME NOT NULL, UNIQUE INDEX UNIQ_95DB9D399B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE client (id BIGINT AUTO_INCREMENT NOT NULL, inn BIGINT UNSIGNED NOT NULL, name VARCHAR(30) NOT NULL, last_name VARCHAR(30) NOT NULL, gender SMALLINT UNSIGNED NOT NULL, birth_date DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
