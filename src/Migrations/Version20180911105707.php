...
final class Version20180911105707 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE account_history (id BIGINT AUTO_INCREMENT NOT NULL, account_id BIGINT NOT NULL, sum NUMERIC(9, 2) NOT NULL, create_dt DATETIME NOT NULL, create_y_m VARCHAR(7) NOT NULL, INDEX IDX_EE9164039B6B5FBA (account_id), INDEX IDX_ac_h_create_y_m (create_y_m), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
